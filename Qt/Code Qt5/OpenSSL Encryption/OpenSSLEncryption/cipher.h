...
#define PADDING RSA_PKCS1_PADDING
#define KEYSIZE 32
#define IVSIZE 32//kích thước của IV và KEY mà generate ra
#define BLOCKSIZE 256//k dùng mà dùng AES_BLOCK_SIZE có sẵn rồi
#define SALTSIZE 8//cái mật khẩu random byte chỉ đc có 8 ký tự
