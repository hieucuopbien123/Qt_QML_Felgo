...
void RateTransfer::scheduleTransfer()
{
    ...
    else
    {
        ...
        //trả ra số mili giây của giây hiện tại
        ...
        //singleShot là hàm call hàm gì sau bao nhiêu giây
    }
...
void RateTransfer::transfer()
{
    ...
    emit(transfered(m_transfered));//cái này chỉ để kiểm tra trạng thái đã đi đến đây=>transfer xong
